...
namespace PiRhoSoft.Composition
{
	...
	public class GraphStore : IVariableDictionary
	{
		...
		private static ClassPool<GraphStore> _pool = new ClassPool<GraphStore>(() => new GraphStore(), 10, 5);

		internal static GraphStore Reserve()
		{
