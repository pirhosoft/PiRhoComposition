...
namespace PiRhoSoft.Composition.Editor
{
	...
	public class GraphAutocompleteItem : AutocompleteItem<Graph>
	{
		...
		private readonly InputAutocompleteItem _input = new InputAutocompleteItem { Name = GraphStore.InputStoreName };
		private readonly OutputAutocompleteItem _output = new OutputAutocompleteItem { Name = GraphStore.OutputStoreName };
		private readonly LocalAutocompleteItem _local = new LocalAutocompleteItem { Name = GraphStore.LocalStoreName };
		private readonly GlobalAutocompleteItem _global = new GlobalAutocompleteItem { Name = GraphStore.GlobalStoreName };
